...
| 人格 | 适合 | 一句话描述 |
|------|------|----------|
| `midnight-friend` | 个人号/自媒体 | 像给朋友发长微信，口语化但不虚构私人场景 |
| `warm-editor` | 生活/文化/情感 | 温暖共情，只使用用户材料或可核验故事 |
| `industry-observer` | 行业媒体/分析 | 克制的专业分析，偶尔锐利 |
| `sharp-journalist` | 新闻/评论 | 短句利落，证据驱动，观点鲜明 |
| `cold-analyst` | 财经/投研 | 严谨数据，专业表达不确定性 |
